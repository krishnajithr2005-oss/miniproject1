                    ...
                    return (
                      <>
                        ...
                        {selectedPlace === "Vellarada" && (() => {
                          ...
                          return (
                            <Marker position={[8.409289, 77.165771]} icon={greenShelterIcon}>
                              <Popup>
                                <strong style={{ color: '#065f46' }}>🏠 Government School in Karakonam</strong>
                                <br />
                                <span style={{ color: '#047857' }}>Emergency Shelter</span>
                              </Popup>
                            </Marker>
                        ...
                        {/* Static Marker for Pattom */}
                        {selectedPlace === "Pattom" && (() => {
                          const greenShelterIcon = L.divIcon({
                            html: `
                              <div style="
                                background-color: #10b981;
                          ...
                          return (
                            <Marker position={[8.52975, 76.98846]} icon={greenShelterIcon}>
                              <Popup>
                                <strong style={{ color: '#065f46' }}>🏠 Govt VHSS Vattiyoorkav</strong>
                                <br />
                                <span style={{ color: '#047857' }}>Emergency Shelter</span>
                              </Popup>
                            </Marker>
                        ...
                        {/* Second static marker for Pattom */}
                        {selectedPlace === "Pattom" && (() => {
                          const greenShelterIcon2 = L.divIcon({
                            html: `
                              <div style="
                                background-color: #10b981;
                                color: white;
                          ...
                          return (
                            <Marker position={[8.5615, 76.9428]} icon={greenShelterIcon2}>
                              <Popup>
                                <strong style={{ color: '#065f46' }}>🏠 Mananthala govt high school</strong>
                                <br />
                                <span style={{ color: '#047857' }}>Emergency Shelter</span>
                              </Popup>
                            </Marker>
                        ...
                        {/* Static Marker for Murinjapalam */}
                        {selectedPlace === "Murinjapalam" && (() => {
                          const greenShelterIcon = L.divIcon({
                            html: `
                              <div style="
                                background-color: #10b981;
                        ...
                        {/* Static Marker for Shangumugham */}
                        {selectedPlace === "Shangumugham" && (() => {
                          const greenShelterIcon = L.divIcon({
                            html: `
                              <div style="
                                background-color: #10b981;
                          ...
                          return (
                            <Marker position={[8.4799, 76.9698]} icon={greenShelterIcon}>
                              <Popup>
                                <strong style={{ color: '#065f46' }}>🏠 Karamana GBHSS</strong>
                                <br />
                                <span style={{ color: '#047857' }}>Emergency Shelter</span>
                              </Popup>
                            </Marker>
                        ...
                        {/* Second static marker for Shangumugham */}
                        {selectedPlace === "Shangumugham" && (() => {
                          const greenShelterIcon2 = L.divIcon({
                            html: `
                              <div style="
